...
/**
 * Componente que muestra información sobre la empresa y sus valores.
 * 
 * Renderiza un encabezado, una descripción general, una imagen del equipo y 
 * una sección con los valores clave de la empresa, cada uno con su respectivo ícono y descripción.
 * Además, incluye un llamado a la acción para unirse a la comunidad.
 * 
 * Utiliza animaciones con framer-motion para una transición suave de los elementos al aparecer en pantalla.
 * 
 * @returns {JSX.Element} - Renderiza el contenido sobre la empresa y sus valores.
 */
