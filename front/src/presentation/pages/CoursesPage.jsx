...
/**
 * Página `CoursesPage` que muestra una lista de cursos en línea con filtros de búsqueda y selección.
 * Permite buscar cursos por nombre, filtrar por categoría y nivel académico, y ver detalles de un curso en un modal.
 * 
 * @returns {JSX.Element} - Componente de la página de cursos, que incluye un campo de búsqueda, 
 *                          selectores para categoría y nivel, y una lista de tarjetas de cursos.
 */
